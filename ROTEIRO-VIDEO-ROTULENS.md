...
## 5. Os textos que entram na tela

Um de cada vez, nunca dois ao mesmo tempo.
...
> celular. Link na bio 🔗
>
> Comenta **ROTULO** que eu te mando no direct.
>
> Leitura de rótulo é orientação geral, não substitui consulta. 💛
...
> Oi! Aqui está o RotuLens 👇
> [seu link]
>
> Abre direto no navegador, não precisa baixar de loja nenhuma. Quando abrir,
> toca em "adicionar à tela de início" que ele fica igual aplicativo no seu
> celular.
>
> Fotografa a tabela nutricional e a lista de ingredientes de qualquer produto
> que ele te explica na hora. Me conta depois qual foi o primeiro rótulo que você
> leu — eu quero saber. 😊

**Não mande só o link.** A frase sobre instalar na tela de início é o que separa
quem usa uma vez de quem volta. E responda também no comentário, em público:
comentário respondido faz a próxima pessoa comentar.

---

## 7. O anúncio

**Objetivo:** tráfego para o link (cliques). Não escolha engajamento — o
comentário da palavra-chave já vem sozinho do post normal.
...
**Público:** mulheres de 25 a 45 anos, interesses de alimentação saudável,
...
- **Não é consulta nem prescrição.** O app faz orientação geral de leitura de
...
**Depois de publicar**
- [ ] Palavra-chave respondida nas primeiras 2 horas
- [ ] Uso do app conferido antes de aumentar a verba:
      `python scripts/rotulens.py uso --dias 7`

Cada leitura do app tem um custo de IA que sai do bolso da Ana, e o app tem teto
de leituras por dia. Se o vídeo pegar, o volume chega junto — vale olhar os
números antes de colocar mais dinheiro no anúncio.
