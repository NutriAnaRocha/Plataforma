...
(function () {
  ...
  function lineChart(pts, labels, unit, resumo) {
    ...
    return '<div class="chart"><div class="chart__head"><span class="chart__big">' + esc(pts[pts.length - 1]) + (unit || "") + "</span>" +
      ...
      '<svg viewBox="0 0 ' + W + " " + H + '" role="img"><defs><linearGradient id="gw" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#0E4C5C" stop-opacity="0.22"/><stop offset="100%" stop-color="#0E4C5C" stop-opacity="0"/></linearGradient></defs>' +
